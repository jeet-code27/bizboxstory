...
import { getCategoryBySlug, getPostsByCategoryPaginated, getFeaturedImageUrl } from '@/lib/wordpress';
...
export default async function CategoryPage({ params, searchParams }) {
  ...
  try {
    const data = await getPostsByCategoryPaginated(category.id, currentPage, 9);
    posts = data.posts;
    ...
    <div className="min-h-screen bg-brand-surface pt-28 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h1 className="font-fraunces text-4xl md:text-5xl lg:text-6xl font-bold text-brand-blue-deep leading-tight" dangerouslySetInnerHTML={{ __html: category.name }} />
          {category.description && (
            <p className="mt-6 font-dm text-lg text-gray-600 leading-relaxed" dangerouslySetInnerHTML={{ __html: category.description }} />
          )}
        </div>
