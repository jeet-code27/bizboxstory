...
export default function RoyalBikersCaseStudy() {
  return (
    <>
      {/* ── HERO SECTION ──────────────────────────────────────────────────*/}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h1 className="font-fraunces text-5xl sm:text-6xl font-bold text-brand-blue-deep leading-tight mb-6">
                Royal Bikers <br />
                <span className="italic text-brand-gold text-4xl sm:text-5xl">£25,000+ Revenue</span>
              </h1>
              <p className="font-dm text-lg text-gray-500 leading-relaxed mb-8">
                How we helped Royal Bikers generate over £25,000 in tour bookings within 2 months through high-converting Meta ad campaigns and targeted creative strategy.
              </p>
      ...
      <section className="py-16 bg-brand-blue-deep text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-white/10 text-center">
            <div className="px-4">
              <p className="font-fraunces text-4xl sm:text-5xl font-bold text-brand-gold mb-2">£25K+</p>
              <p className="font-dm text-sm uppercase tracking-wider opacity-80">Booking Revenue</p>
            </div>
            <div className="px-4">
              <p className="font-fraunces text-4xl sm:text-5xl font-bold text-brand-gold mb-2">₹70K</p>
              <p className="font-dm text-sm uppercase tracking-wider opacity-80">Ad Spend</p>
            </div>
            <div className="px-4">
              <p className="font-fraunces text-4xl sm:text-5xl font-bold text-brand-gold mb-2">2</p>
              <p className="font-dm text-sm uppercase tracking-wider opacity-80">Months</p>
            </div>
            <div className="px-4">
              <p className="font-fraunces text-4xl sm:text-5xl font-bold text-brand-gold mb-2">High</p>
              <p className="font-dm text-sm uppercase tracking-wider opacity-80">Conversion Rate</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            ...
            <p className="font-dm text-lg text-gray-600 leading-relaxed bg-brand-surface p-8 rounded-2xl border border-brand-border">
              Royal Bikers wanted to increase tour bookings and generate qualified leads for their premium motorcycle tours while keeping ad spend efficient. The goal was to attract international travelers, improve lead quality, and turn Meta ads into a consistent booking channel.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              {[
                "Generated over £25,000 (15 Lakh) in booking revenue within 2 months.",
                "Achieved results with an ad spend of approximately ₹70,000 INR through optimized Meta campaigns.",
                "Created high-converting ad creatives focused on adventure travel and premium riding experiences.",
                "Improved lead quality through audience targeting, retargeting, and conversion-focused campaign structures.",
                "Increased website traffic and inquiry volume from international motorcycle travel audiences.",
                "Optimized landing pages and campaign funnels for better conversion rates and lower cost per lead.",
                "Built a scalable Meta ads strategy focused on consistent booking growth."
              ].map((item, index) => (
                <motion.div
                  key={index}
      ...
      <section className="py-24 bg-brand-surface relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <blockquote className="font-fraunces text-2xl sm:text-3xl leading-relaxed text-brand-blue-deep italic mb-10">
            &quot;The campaigns helped us generate consistent tour inquiries and high-value bookings while keeping advertising costs efficient and scalable. Highly recommended for brands looking to generate actual revenue through paid marketing.&quot;
          </blockquote>
          <div className="font-dm">
            <p className="font-bold text-gray-900 text-lg">Royal Bikers Team</p>
            <p className="text-brand-gold mt-1">Royal Bikers</p>
          </div>
        </div>
      </section>
