...
export default function TorchCannabisPage() {
  return (
    <>
      {/* ── HERO SECTION ──────────────────────────────────────────────────*/}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h1 className="font-fraunces text-5xl sm:text-6xl font-bold text-brand-blue-deep leading-tight mb-6">
                Torch Cannabis <br />
                <span className="italic text-brand-gold text-4xl sm:text-5xl">320K+ Video Views</span>
              </h1>
              <p className="font-dm text-lg text-gray-500 leading-relaxed mb-8">
                How we helped a fast-growing cannabis dispensary build local brand awareness, drive 193% more engagement, and generate consistent visibility through high-performing social content and strategic digital positioning.
              </p>
            ...
            >
              ...
              <div className="relative rounded-3xl overflow-hidden border border-brand-border shadow-2xl bg-white">
                <img
                  ...
                  className="w-full aspect-video object-4"
                />
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-16 bg-brand-blue-deep text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-white/10 text-center">
            <div className="px-4">
              <p className="font-fraunces text-4xl sm:text-5xl font-bold text-brand-gold mb-2">320K+</p>
              <p className="font-dm text-sm uppercase tracking-wider opacity-80">Video Views</p>
            </div>
            <div className="px-4">
              <p className="font-fraunces text-4xl sm:text-5xl font-bold text-brand-gold mb-2">+193%</p>
              <p className="font-dm text-sm uppercase tracking-wider opacity-80">Engagement Growth</p>
            </div>
            <div className="px-4">
              <p className="font-fraunces text-4xl sm:text-5xl font-bold text-brand-gold mb-2">2,400+</p>
              <p className="font-dm text-sm uppercase tracking-wider opacity-80">Profile Actions</p>
            </div>
            <div className="px-4">
              <p className="font-fraunces text-4xl sm:text-5xl font-bold text-brand-gold mb-2">Local</p>
              <p className="font-dm text-sm uppercase tracking-wider opacity-80">Brand Authority</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            ...
            <p className="font-dm text-lg text-gray-600 leading-relaxed bg-brand-surface p-8 rounded-2xl border border-brand-border">
              Torch Cannabis Dispensary needed to grow its digital presence in a highly competitive cannabis market where standing out organically is difficult due to platform restrictions, ad limitations, and heavy local competition. The goal was to build a recognizable brand identity, create high-retention social content, and increase customer engagement while keeping the content authentic, educational, and community-driven.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              {[
                "Generated consistent revenue across social platforms through short-form content and trend-focused creatives.",
                "Increased engagement by 193% with educational cannabis content, product showcases, and community-focused campaigns.",
                "Achieved 320K+ video views through high-retention reels optimized for local discovery and shareability.",
                "Improved profile activity with 2,400+ profile actions, helping increase store awareness and repeat customer interest.",
                "Built a content ecosystem focused on dispensary culture, product education, lifestyle positioning, and community engagement.",
                "Developed a visual identity that helped Torch Cannabis stand out while maintaining platform-safe content strategies.",
              ].map((item, index) => (
                <motion.div
                  key={index}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="font-dm text-gray-500 mt-4 max-w-xl mx-auto">
              Real orders flowing in — a direct result of the brand visibility and engagement we built through consistent social content.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative rounded-3xl overflow-hidden border border-brand-border shadow-2xl bg-white">
              <img
                src="/images/case-studies/torch-cannabis-orders.png"
                alt="Torch Cannabis Orders Dashboard — Real Sales Results"
            ...
            <div className="mt-6 flex items-center justify-center gap-3 flex-wrap">
              <span className="inline-flex items-center gap-2 px-6 py-3 bg-white border border-brand-border rounded-full shadow-sm">
                ...
                <span className="font-dm text-gray-600 text-sm">
                  Last month&apos;s gross sales —
                </span>
                <span className="font-fraunces text-2xl font-bold text-brand-blue-deep">$2,390</span>
                <span className="font-dm text-gray-500 text-sm">in revenue generated</span>
              </span>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-24 bg-brand-surface relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <blockquote className="font-fraunces text-2xl sm:text-3xl leading-relaxed text-brand-blue-deep italic mb-10">
            &quot;Biz Box Story helped us create content that actually connected with people. The growth felt natural, the engagement kept compounding, and our brand visibility increased massively in a short time.&quot;
          </blockquote>
          <div className="font-dm">
            <p className="font-bold text-gray-900 text-lg">Torch Cannabis Team</p>
            <p className="text-brand-gold mt-1">Torch Cannabis Dispensary</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-brand-blue-deep text-center">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="font-dm text-lg text-white/70 mb-10">
            Let&apos;s build organic brand authority and drive real results for your business — no matter the niche.
          </p>
          <Link
            href="/contact"
